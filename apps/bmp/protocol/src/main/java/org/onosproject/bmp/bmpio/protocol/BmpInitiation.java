...
/**
 * Abstraction of an entity providing BMP initiation message.
 */
public interface BmpInitiation extends BmpMessage {
    ...
    /**
     * Builder interface with get and set functions to build BmpInitiation message.
     */
