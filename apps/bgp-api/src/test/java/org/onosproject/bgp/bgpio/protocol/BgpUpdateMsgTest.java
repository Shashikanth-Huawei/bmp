...
import org.onosproject.bgp.bgpio.types.As4Path;
...
import org.onosproject.bgp.bgpio.types.IPReachabilityInformationTlv;
...
import org.onosproject.bgp.bgpio.types.NextHop;
...
public class BgpUpdateMsgTest {
    ...
    public void bgpUpdateMessageTest18() throws BgpParseException {
        ...
        NlriType nlriType = org.onosproject.bgp.bgpio.protocol.NlriType.NODE;
    ...
    public void bgpUpdateMessageTest19() throws BgpParseException {
        ...
        ListIterator<BgpLSNlri> list1 = testMpReachNlri.listIterator();
        BgpLSNlri testnlri =  list1.next();
        NlriType nlriType = org.onosproject.bgp.bgpio.protocol.NlriType.PREFIX_IPV4;
        ProtocolType protocolId = org.onosproject.bgp.bgpio.protocol.linkstate.
                BgpNodeLSNlriVer4.ProtocolType.ISIS_LEVEL_TWO;
        assertThat(testnlri.getIdentifier(), is((long) 0));
        assertThat(testnlri.getNlriType(), is(nlriType));
